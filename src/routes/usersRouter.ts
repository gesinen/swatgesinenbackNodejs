...
class UsersRouter {
   ...
   * GET ('/information/:id')
   */
  public getUserInformationAction = () =>
    this.router.get("/information/:id", (req: Request, res: Response) => {
   ...
   * GET ('/login')
   */
  public getUserIdByMailAction = () =>
    this.router.post("/getUserByNif/:mail", (req: Request, res: Response) => {
