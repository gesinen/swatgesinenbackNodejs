...
class WaterGroupsRouter {
   ...
   * params user_id -> id of the user we want to get users from
   */
  public getWaterRootGroupByUser = () =>
    this.router.get("/root/:user_id", (req: Request, res: Response) => {
      const params = req.params;
   ...
   * params user_id -> id of the user we want to get users from
   */
  public getWaterGroupByParent = () =>
    this.router.get("/parent/:group_id", (req: Request, res: Response) => {
      const params = req.params;
