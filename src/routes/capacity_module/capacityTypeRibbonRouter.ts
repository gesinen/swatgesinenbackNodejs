...
class CapacityTypeRibbonRouter {
   ...
   * POST ('/')
   */
  public createCapacityRibbonDevice = () =>
    this.router.post("/", (req: Request, res: Response) => {
      const params = req.body;

      capacityTypeRibbonController
        .createCapacityRibbonDevice(
          parseInt(params.capacityDeviceId),
          parseInt(params.parkingId)
        )
        .then((response) => {
          res.send(response);
        })
   ...
   * GET ('/:id')
   */
  public getCapacityRibbonDeviceById = () =>
   ...
   * GET ('/:id')
   */
  public getAllCapacityRibbonDevicesInner = () =>
  ...
  public removeCapacityRibbonDevice = () =>
   ...
   * PUT ('/:id')
   */
  public updateCapacityRibbonDevice = () =>
