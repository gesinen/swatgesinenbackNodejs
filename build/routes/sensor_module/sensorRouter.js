...
class SensorRouter {
    constructor() {
        ...
        this.getSensorGatewayIdAction = () => this.router.get('/sensorGatewayId/:sensorId', (req, res) => {
            sensorController_1.default.getSensorGatewayId(req.params.sensorId)
                .then(response => {
                res.send(response);
            })
                .catch(err => {
        ...
        this.getSensorSentiloObservationsAction = () => this.router.get('/observations/:sensorId', (req, res) => {
            ...
            sensorController_1.default.addSensorObservationsFromSentilo(parseInt(req.params.sensorId), 1, 1, 1)
                .then(response => {
                res.send(response);
            })
                .catch(err => {
