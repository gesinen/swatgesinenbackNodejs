                ...
                database_1.default.getConnection((err, conn) => {
                    ...
                    json_file_data.forEach((element, index) => {
                        values_to_insert += "('" + Utils_1.Utils.checkUndefined(element.first_name) + "','" + Utils_1.Utils.checkUndefined(element.last_name) + "','" + Utils_1.Utils.checkUndefined(element.email) + "','" + Utils_1.Utils.checkUndefined(element.user_nif) + "','" + Utils_1.Utils.checkUndefined(element.mobile) + "','" +
                            Utils_1.Utils.checkUndefined(user_id) + "','" + Utils_1.Utils.checkUndefined(municipality_id) + "','" + Utils_1.Utils.checkUndefined(element.water_device_id) + "','" + Utils_1.Utils.checkUndefined(element.dob) + "','" + Utils_1.Utils.checkUndefined(element.user_created_dt) + "','" + Utils_1.Utils.checkUndefined(element.house_no) + "','" +
                            Utils_1.Utils.checkUndefined(element.street) + "','" + Utils_1.Utils.checkUndefined(element.address) + "','" + Utils_1.Utils.checkUndefined(element.city) + "','" + Utils_1.Utils.checkUndefined(element.state) + "','" + Utils_1.Utils.checkUndefined(element.country) + "','" + Utils_1.Utils.checkUndefined(element.zip_code) + "','" + Utils_1.Utils.checkUndefined(element.same_address) + "','" +
                            Utils_1.Utils.checkUndefined(element.bill_house_no) + "','" + Utils_1.Utils.checkUndefined(element.bill_street) + "','" + Utils_1.Utils.checkUndefined(element.bill_address) + "','" + Utils_1.Utils.checkUndefined(element.bill_city) + "','" + Utils_1.Utils.checkUndefined(element.bill_state) + "','" + Utils_1.Utils.checkUndefined(element.bill_country) + "','" +
                            Utils_1.Utils.checkUndefined(element.bill_zip_code) + "','" + Utils_1.Utils.checkUndefined(element.bank_name) + "','" + Utils_1.Utils.checkUndefined(element.bank_address) + "','" + Utils_1.Utils.checkUndefined(element.IBAN) + "','" + Utils_1.Utils.checkUndefined(element.profile_pic) + "','" + Utils_1.Utils.checkUndefined(element.account_certificate) + "','" +
                            Utils_1.Utils.checkUndefined(element.idproof) + "','" + Utils_1.Utils.checkUndefined(element.sepa) + "','" + Utils_1.Utils.checkUndefined(element.dni) + "','" + Utils_1.Utils.checkUndefined(element.created_at) + "','" + Utils_1.Utils.checkUndefined(element.updated_at) + "'),";
                    });
